...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        messageLineEdit->setGeometry(QRect(80, 350, 281, 25));
        portLineEdit = new QLineEdit(Widget);
        portLineEdit->setObjectName(QString::fromUtf8("portLineEdit"));
        portLineEdit->setGeometry(QRect(110, 49, 200, 25));
        portLineEdit->setMinimumSize(QSize(200, 0));
        ipLineEdit = new QLineEdit(Widget);
        ipLineEdit->setObjectName(QString::fromUtf8("ipLineEdit"));
        ipLineEdit->setGeometry(QRect(110, 18, 200, 25));
        ipLineEdit->setMinimumSize(QSize(200, 0));
        label = new QLabel(Widget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(20, 20, 91, 23));
        label_3 = new QLabel(Widget);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setGeometry(QRect(60, 50, 51, 23));
        sendButton = new QPushButton(Widget);
        sendButton->setObjectName(QString::fromUtf8("sendButton"));
        sendButton->setGeometry(QRect(370, 350, 80, 31));
        label_4 = new QLabel(Widget);
        label_4->setObjectName(QString::fromUtf8("label_4"));
        label_4->setGeometry(QRect(40, 80, 61, 23));
        label_2 = new QLabel(Widget);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(20, 350, 46, 23));
        connectButton = new QPushButton(Widget);
        connectButton->setObjectName(QString::fromUtf8("connectButton"));
        connectButton->setEnabled(true);
        connectButton->setGeometry(QRect(320, 80, 80, 31));
        connectButton->setAutoFillBackground(false);
        connectButton->setIconSize(QSize(16, 16));
        listWidget = new QListWidget(Widget);
        listWidget->setObjectName(QString::fromUtf8("listWidget"));
        listWidget->setGeometry(QRect(20, 120, 431, 211));
        ...
        nicname->setGeometry(QRect(110, 80, 201, 25));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        label->setText(QApplication::translate("Widget", "IP Address :", nullptr));
        label_3->setText(QApplication::translate("Widget", "Port :", nullptr));
        sendButton->setText(QApplication::translate("Widget", "\354\240\204\354\206\241", nullptr));
        label_4->setText(QApplication::translate("Widget", "User ID : ", nullptr));
        ...
        fileSendButton->setText(QApplication::translate("Widget", "\355\214\214\354\235\274 \354\204\240\355\203\235", nullptr));
        filefindbutton->setText(QApplication::translate("Widget", "\355\214\214\354\235\274 \354\240\204\354\206\241", nullptr));
    } // retranslateUi
